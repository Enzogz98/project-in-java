...
async function listarAlumn() {
    ...
    resp.data.forEach(element => {
        ...
        "<b> Nombre: </b>" + element.nombre + " <b>Dni: </b>" + element.dni + "<b> Direccion: </b>" + element.direccion + "  <b>Institucion: </b>"+ element.institucion + ' <button class="btn btn-dark" onclick="editar(' + element.id + ')"> Editar</button>' + "<br>"
    });
}
